...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Click to sort");                                                         // Line 124
	echo T_("Answer");                                                                // Line 74
	echo T_("Count");                                                                 // Line 24
	echo T_("Percent");                                                               // Line 125
	echo T_("%");                                                                     // Line 140
	echo T_("Sum");                                                                   // Line 138
	echo T_("Answers");                                                               // Line 158
