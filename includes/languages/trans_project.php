...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Create New Poll");                                                       // Line 21
	echo T_("Ask Me");                                                                // Line 281
	echo T_("Welcome");                                                               // Line 31
	echo T_("Dashboard");                                                             // Line 34
	echo T_("Exit");                                                                  // Line 35
	echo T_("Enter");                                                                 // Line 41
