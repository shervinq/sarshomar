...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("I want to experience Sarshomar!");                                       // Line 31
	...
	echo T_("Add new question");                                                      // Line 73
	echo T_("Question Sorter");                                                       // Line 74
	echo T_("Settings");                                                              // Line 21
	echo T_("General Settings");                                                      // Line 24
	echo T_("Welcome message");                                                       // Line 17
	echo T_("Thank you message");                                                     // Line 72
	echo T_("Privacy");                                                               // Line 167
	echo T_("Advance");                                                               // Line 178
	echo T_("Survey status");                                                         // Line 7
	...
	echo T_("Password");                                                              // Line 113
	echo T_("Enter your password");                                                   // Line 38
	echo T_("Save question title");                                                   // Line 44

	//--------------------------------------------content_a\question\home\display.html
	echo T_("Edit");                                                                  // Line 72
	echo T_("Have Media");                                                            // Line 79
	echo T_("Type");                                                                  // Line 11
	echo T_("Choice");                                                                // Line 26
	echo T_("Require");                                                               // Line 95
	echo T_("Operation");                                                             // Line 13
	echo T_("Untitled");                                                              // Line 51
	echo T_("Required answer");                                                       // Line 38
	echo T_("Optional to answer");                                                    // Line 40

	//--------------------------------------------------content_a\question\layout.html
	echo T_("Placeholder");                                                           // Line 53
	echo T_("Type here ...");                                                         // Line 314
	...
	echo T_("Next");                                                                  // Line 296
	echo T_("Add");                                                                   // Line 209
	echo T_("Download PDF");                                                          // Line 85
	echo T_("Download File");                                                         // Line 87
	...
	echo T_("Without welcome message");                                               // Line 28
	echo T_("Without thank you message");                                             // Line 83
	...
	//------------------------------------------content_a\survey\thankyou\display.html
