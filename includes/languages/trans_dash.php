...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Select one item");                                                       // Line 253
	...
	echo T_("Enable");                                                                // Line 254
	echo T_("Disable");                                                               // Line 255
