...
class create_advance
{
	...
	public static function description($_query = null, $_data_url = null)
	{
		...
		switch (isset($_data_url[2]) ? $_data_url[2] : null) {
			case 'remove':
				step::goingto(2);
				$return = \content\saloos_tg\sarshomar_bot\commands\step_create_advance::step2(null, 'remove');
				break;
			default:
				step::goingto(2);
				$return = \content\saloos_tg\sarshomar_bot\commands\step_create_advance::step2();
				break;
		}
	...
	public static function privacy($_query = null, $_data_url = null)
	{
		...
		session::remove_back('expire', 'inline_cache', 'create');
		session::remove('expire', 'inline_cache', 'create');
		callback_query::edit_message(\content\saloos_tg\sarshomar_bot\commands\step_create_advance::step3());
		return [];
	}
